...
ggsave("Graphs/operators.png", plot = p_operators, units = "in", width = 7, height = 432/700 * 7)
ggsave("Graphs/frequency.png", plot = p_clue_share, units = "in", width = 7, height = 432/700 * 7)
```
